...
ALIVE_PIC = getenv("ALIVE_PIC", "https://graph.org/file/6519b78c59d6d5df56a85.jpg")
OWNER_ID = int(getenv("OWNER_ID", "7971457644"))
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", "7971457644").split(" ")))
